...
from .forms import TelegramPaymentForm

TEMPLATE_PATH = "order/payment/telegram.html"
...
def create_form(data, payment_information, connection_params):
    return TelegramPaymentForm(data=data, order_id=payment_information.order_id)
